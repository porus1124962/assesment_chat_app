...
class _HomePageState extends State<HomePage> {
  ...
  Message? _lastMessageForUser(UserListLoaded state, String userId) {
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            if (_currentUserId != null) {
              await context
                  .read<UserListCubit>()
                  .fetchConversationPartners(_currentUserId!);
            }
          },
          child: Column(
            children: [
                  ...
                  builder: (context, state) {
                    ...
                    if (state is UserListError) {
                      return error_widget.ErrorWidget(
                        ...
                        onRetry: () {
                          context.read<UserListCubit>().retryFetch(currentUserId: _currentUserId);
                        },
                      );
                    }
